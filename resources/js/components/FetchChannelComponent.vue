  ...
  <div class="channel-box mb-3">
    <div>
      <label for="exampleFormControlInput1" class="form-label"
        >Select your YouTube channel</label
      >
      <input
        type="text"
        class="form-control"
      ...
      <div class="scroll" v-if="seen">
        <div v-for="channel in channels.items" :key="channel.id">
          <div
            ...
            @click="chooseChannel(channel.snippet.title)"
          >
            <div class="channel-thumbnail">
              <img v-bind:src="channel.snippet.thumbnails.default.url" />
            </div>
    ...
    <div>
      ...
      <b-icon
        ...
        variant="light"
        @click="removeChannel(channel.snippet.title)"
...
export default {
  ...
  methods: {
    getChannel() {
      this.axios
        .get(
          `https:youtube.googleapis.com/youtube/v3/search?part=snippet&maxResults=5&q=${this.search}&type=channel&key=AIzaSyDOMtfi1bF4YpFgN8JPfnn7kjVf91-MkOA&fields=items(id(channelId),snippet(title,thumbnails(default)))`
        )
        .then((response) => {
